...
If the parameter in the "Import Data" tab are correct, in "Germination analysis" tab will be appear the values of the eleven germination variables for each experimental unit. Figure \@ref(fig:var)

```{r var, out.width='70%', fig.cap='Variables calculated with GerminaQuant',fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html')}
