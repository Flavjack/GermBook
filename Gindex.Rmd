...
```{r varsum, out.width='70%', fig.cap='Limits of the each germination variable; n: number of total seed in germination condition.',fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html')}
