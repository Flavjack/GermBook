...
```{r icon, out.width='30%', fig.align='center',include=identical(knitr:::pandoc_to(), 'html')}
...
```{r univ, out.width='15%', fig.align='center', include=identical(knitr:::pandoc_to(), 'html')}
